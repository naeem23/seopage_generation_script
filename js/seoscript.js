(function ($) {
    ...
    $(document).ready(function () {
        ...
        const apiKey = 'a32939db414e4e2a8885fefcb92b75f3';
        const newsapi_url = `https://newsapi.org/v2/everything?q=${area}, UK local business&sortBy=publishedAt&pageSize=10&apiKey=${apiKey}`;
        fetch(newsapi_url)
            ...
            .then((data) => {
                ...
                articles.forEach((news) => {
                    ...
                    postSourceSpan.textContent = news.source.name;
                    ...
                    postDateSpan.textContent = news.publishedAt
                        .replace('T', ' ')
                        .replace('Z', '');
